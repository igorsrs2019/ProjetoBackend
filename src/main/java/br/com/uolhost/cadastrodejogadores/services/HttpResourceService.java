...
public class HttpResourceService {
    ...
    public JsonDTO requestVingadores() throws ResourceHttpIsNotAvailableException, JsonProcessingException {
        return this.mapper.readValue(this.requestByUrl(urlJson), JsonDTO.class);
    }

    public XmlDTO requestLiga() throws ResourceHttpIsNotAvailableException, JsonProcessingException {
